...
public class MergeContact {
		...
		public static void main(String[] args) {
			...
			ArrayList<String> window1 = new ArrayList<String>(windowHandles1);
		...
		private static void extracted(ChromeDriver driver, ArrayList<String> window) {
